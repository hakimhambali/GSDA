            ...
            <div class="card" style="box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;border-radius: 5px;">
                <div class="card-body" >
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" style="font-weight:500">Answer Explanation (Optional)</label>
                                <input wire:model="answer_explanation" type="text" id="answer_explanation" name="answer_explanation" class="form-control" >
                                @error('answer_explanation') <span class="error" style="color:red"><b>{{ $message }}</b></span> @enderror
                            </div>
                        </div>
