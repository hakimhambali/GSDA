                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" style="font-weight:500">Topic Name</label>
                                <select wire:model="topic_name" name="topic_name" id="topic_name" class="form-control custom-select" data-placeholder="Choose Topic" tabindex="1">
                                    <option value="">-- Choose Topic --</option>
                                    @foreach ($courses as $course)
                                        <option value="{{$course->id}}">{{$course->name}}</option>
                                    @endforeach
                                </select>
                                @error('topic_name') <span class="error" style="color:red"><b>{{ $message }}</b></span> @enderror
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{-- <div class="form-group">
                                <label class="control-label" style="font-weight:500">Hour (Optional)</label>
                                <input wire:model="hour_allocated" type="number" id="hour_allocated" name="hour_allocated" class="form-control" min="0" max="99999"> 
                                @error('hour_allocated') <span class="error" style="color:red"><b>{{ $message }}</b></span> @enderror
                            </div> --}}
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" style="font-weight:500">Minute (Optional)</label>
                                <input wire:model="minute_allocated" type="number" id="minute_allocated" name="minute_allocated" class="form-control" min="0" max="59">
                                @error('minute_allocated') <span class="error" style="color:red"><b>{{ $message }}</b></span> @enderror
                            </div>
                        </div>
