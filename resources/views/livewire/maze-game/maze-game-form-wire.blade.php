<div>
    {{-- @livewire('maze-game.maze-game-form-wire', ['id_question' => $Question->id] ) --}}
    <!doctype html>
...
<body>
    ...
    <button class="btn btn-success" id="myBtn2">Medium</button>
    <button class="btn btn-success" id="myBtn3">Difficulty</button>
<section>
    <div id="wrapper" style="margin-left:auto; margin-right:auto;">
        ...
        <div id="maze">
            <p style="text-align: center;margin-bottom: 10px">Lets find the way out of Maze !</p>
            <div id="menu">
    ...
    <script type="text/javascript">
        ...
        // var difficulty = document.getElementById("difficulty.val");
